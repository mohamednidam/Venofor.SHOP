/*! elementor - v2.6.8 - 07-08-2019 */ ! function(t) {
    var e = {};
    ...
    t.exports = function(t, e) {
        ...
        return function(e, c, h) {
            for (var d, g, y = i(e), m = o(y), x = r(c, h, 3), b = u(m.length), S = 0, O = n ? v(e, b) : s ? v(e, 0) : void 0; b > S; S++)
    ...
    var r = n(5),
        ...
        J = function(t, e, n) {
            return t === H && J(V, e, n), m(t), e = O(e, !0), m(n), o(G, e) ? (n.enumerable ? (o(t, A) && t[A][e] && (t[A][e] = !1), n = E(n, {
                enumerable: _(0, !1)
            })) : (o(t, A) || C(t, A, _(1, {})), t[A][e] = !0), B(t, e, n)) : C(t, e, n)
        },
        K = function(t, e) {
            m(t);
        ...
        return h = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, e) {
            ...
            for (var b = 0, S = 0, O = []; S < p.length;) {
                ...
                if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === b) S = u(p, S, g);
                    ...
                    for (var w = 1; w <= E.length - 1; w++)
                        if (O.push(E[w]), O.length === x) return O;
                    S = b = _
                }
            }
    ...
    for (var r = n(153), o = n(151), i = n(27), u = n(9), c = n(21), s = n(143), f = n(8), a = f("iterator"), l = f("toStringTag"), p = s.Array, v = {
        ...
        var g, y = h[d],
            ...
            x = u[y],
            b = x && x.prototype;
        if (b && (b[a] || c(b, a, p), b[l] || c(b, l, y), s[y] = p, m))
